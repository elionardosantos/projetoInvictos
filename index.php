...
<body>
    ...
    <div class="container my-3">
        <a href="novo_orcamento.php" class="btn btn-primary" role="button">Novo Orçamento</a>
        <a href="consulta_cnpj_visualizacao.php" class="btn btn-primary" role="button">Consultar CNPJ</a>
    </div>
