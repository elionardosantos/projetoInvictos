...
// Dados do contato
echo "contatoId: " . $contatoId = isset($_POST['contatoId'])?$_POST['contatoId']:""; echo "<br>";
...
echo "municipioServico: " . $municipioServico = isset($_POST['municipioServico'])?$_POST['municipioServico']:""; echo "<br>";
