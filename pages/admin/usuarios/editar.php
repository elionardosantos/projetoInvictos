    ...
    <?php
        ...
        if(isset($_POST['formName']) && isset($_POST['formEmail']) && isset($_POST['formLevel'])){
            ...
            if($stmt->execute() === TRUE) {
                $screenMessage = "<div class=\"alert alert-success\">Usuário atualizado. As novas configurações serão aplicadas na próxima vez que o usuário logar no sistema.</div>";
            } else {
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="apagar_process.php?id=<?= $userId; ?>">
