...
<body>
            ...
            function cnpjQuery() {
                ...
                if($cnpj === ''){
                    ...
                    if(isset($data->company->name)){
                        ...
                        $registration = isset($data->registrations)?$data->registrations:null;
                        ...
                        echo "<div class='alert alert-danger mt-3'>Você excedeu o limite de consultas por minuto. Por favor aguarde um pouco para consultar novamente</div>";
                    }
                    else {
    ...
    <div class="container mt-4">
        <form action="novo_itens.php" method="POST">
