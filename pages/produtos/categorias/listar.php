...
<body>
    ...
    <div class="container my-3">
        <a href="nova.php" class="btn btn-primary" role="button">Cadastrar nova categoria</a>
    </div>
    <div class="container my-3">
                                ...
                                <?php
                                    if($result) {
                                        ...
                                        foreach($result as $row) {
                                            ...
                                            echo "<td><a href=\"editar.php?id=$categId\" class=\"btn btn-primary btn-sm\">Editar</a></td>";
                                            echo "</tr>";
                                        }
                                    }
